...
var OauthReceiver = function (_React$Component) {
  ...
  createClass(OauthReceiver, [{
    ...
    value: function () {
      ...
      if (component != null) {
        return createElement(component, { processing: processing, state: state, error: error });
      }
...
function createOauthFlow() {
  ...
  return {
    Sender: function Sender(props) {
      return createElement(OauthSender, _extends({
    ...
    Receiver: function Receiver(props) {
      return createElement(OauthReceiver, _extends({
        tokenUrl: tokenUrl,
        clientId: clientId,
